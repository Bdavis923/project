...
Muse.Utils.initWidget('#accordionu1583', ['#bp_780', '#bp_480'], function(elem) { return new WebPro.Widget.Accordion(elem, {canCloseAll:true,defaultIndex:-1}); });/* #accordionu1583 */
$('#bp_infinity').one('muse_this_bp_activate', function(){
$('#u2913-bw').registerPositionScrollEffect([{"in":[-Infinity,0],"speed":[null,0]},{"in":[0,Infinity],"speed":[null,0]}], $(this)); /* scroll effect */
$('#u2359').registerPositionScrollEffect([{"in":[-Infinity,0],"speed":[1,0]},{"in":[0,Infinity],"speed":[0,0]}], $(this)); /* scroll effect */
