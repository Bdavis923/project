...
public class Ticket {
	...
	@JoinColumn(name = "Customer", nullable = false, referencedColumnName= "VID")
	private Customer customer;
	
	@ManyToOne(fetch = FetchType.EAGER, targetEntity= Employee.class)
	@JoinColumn(name = "Asigned_To", referencedColumnName= "Employee_ID")
	private Employee employee;
	
	@ManyToOne(fetch = FetchType.EAGER, targetEntity= Equipment.class)
	@JoinColumn(name = "Equipment", nullable = false, referencedColumnName= "Equipment_ID")
